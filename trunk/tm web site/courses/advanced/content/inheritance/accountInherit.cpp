...
/*#TC*/ class Checking: public Account{	
...
/*#TD*/ class Savings: public Account{
...
int main(){
/*#TF*/	Account mine, yours;	// "Generic" accounts
...
// How come we didn't get any interest??
	...
	myChecking.monthEnd();
	cout << "my Checking Balance is " << myChecking.getBalance() << endl;/*#/TD*/
