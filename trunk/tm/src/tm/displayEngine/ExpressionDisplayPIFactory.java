...
public class ExpressionDisplayPIFactory implements DisplayPIFactoryIntf{
	...
	private ExpressionDisplayPIFactory(String parameter){
		configId = parameter;
	}

	
    static public ExpressionDisplayPIFactory createInstance( String parameter ) {
	...
	public String toString(){return "ExpressionDisplayPiFactory("+configId+")";}
