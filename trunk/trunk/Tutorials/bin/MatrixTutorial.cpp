...
int main()
{
	 ...
	 ScriptManager::relay("HigraphManager","setDefaultNodeSize", 30, 30);
...
void add1(int func_matrix[], int rows, int columns)
{
	...
	ScriptManager::relay("HigraphManager","placeNode",name,200,350);
	...
	ScriptManager::relay("HigraphManager","placeNode",target,232,280);
