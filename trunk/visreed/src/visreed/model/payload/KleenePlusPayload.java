...
import visreed.view.KleenePlusNodeView;
import visreed.view.VisreedNodeView;

public class KleenePlusPayload extends VisreedPayload {

	public KleenePlusPayload() {
		super(VisreedTag.KLEENE_PLUS);
	}
    ...
    public VisreedNodeView constructView(
        ...
        return new KleenePlusNodeView(sgv, node, timeman);
    }
}
