...
public enum PLAYTag implements Tag<PLAYTag, PLAYPayload> {
	...
	CLASS {
		...
		public boolean contentModel(List<PLAYTag> seq) {
			...
			if(!(seq.get(0).equals(VARDECL))){
				return false;
			}
			for (int i = 1; i < seq.size() - 1; i++) {
				if (!(seq.get(i).equals(VARDECL)||seq.get(i).equals(METHOD)))
					return false;
			}

			if(!(seq.get(seq.size() - 1).equals(METHOD))){
				return false;
			}
			return true;
		}
	...
	PLUS {
		...
		@Override
		public PLAYPayload defaultPayload() {
			return new PLAYPayload("PLUS", PLUS);
		}
	...
	MINUS {
		...
		@Override
		public PLAYPayload defaultPayload() {
			return new PLAYPayload("MINUS", MINUS);
		}
	...
	DIVIDE {
		...
		@Override
		public PLAYPayload defaultPayload() {
			return new PLAYPayload("DIVIDE", DIVIDE);
		}
	...
	MULTIPLY {
		...
		@Override
		public PLAYPayload defaultPayload() {
			return new PLAYPayload("MULTIPLY", MULTIPLY);
		}
	...
	LESS {
		...
		@Override
		public PLAYPayload defaultPayload() {
			return new PLAYPayload("LESS", LESS);
		}
	...
	GREATER {
		...
		@Override
		public PLAYPayload defaultPayload() {
			return new PLAYPayload("GREATER", GREATER);
		}
	...
	public boolean isExp(PLAYTag pt) {
		return pt.equals(NUMBERLITERAL) || pt.equals(STRINGLITERAL)
				...
				|| pt.equals(WHILE) || pt.equals(ASSIGN)|| pt.equals(PLUS)
				|| pt.equals(MINUS) || pt.equals(DIVIDE) || pt.equals(MULTIPLY) 
				|| pt.equals(LESS) || pt.equals(GREATER) || pt.equals(EXPPLACEHOLDER);
	}
