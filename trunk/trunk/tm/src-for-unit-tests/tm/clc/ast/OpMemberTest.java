...
public class OpMemberTest extends Cpp_AbstractAstTest {

    public OpMemberTest() { super ("OpMemberTest"); }
    public OpMemberTest (String name) { super (name); }
                           ...
                           int address )
    {
        ...
        OpMember nd = new OpMember(
            ref_int, ".",
            f_name, path, f_scoped_name,
            operand ) ;
