...
*/
    ...
    public void enqueue(int v, int pi) {
        ...
        if( location[v] != -1) {
            ...
            ScriptManager.relay("HigraphManager", "setNodeFillColor", location[v], PDV.AQUA) ; 
...
/*#T ww*/
    private void findShortestPathsFrom(int s) {
        ...
        queue.enqueue(s, 0) ; /*#I
        ScriptManager.relay("HigraphManager", "setNodeFillColor", d[0], PDV.AQUA);
         */
        while( ! queue.isEmpty() ) {
            // The AQUA node with the lowest label is suitable
            ...
            ScriptManager.relay("HigraphManager", "setNodeFillColor", d[v], PDV.RED);
            ...
            for( int i = 0 ; i < outgoing.length ; ++i ) {
                ...
                if( d[u] == -1 || d[u] > d[v] + distance ) {
                    ...
                    ScriptManager.relay("HigraphManager", "setNodeFillColor", d[u], PDV.AQUA);*/
                } /*#I else {
