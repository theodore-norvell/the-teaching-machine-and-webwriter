    ...
    var MockJSTM = (function () {
        ...
        MockJSTM.prototype.updateDisplays = function () {
            ...
            if (this.globalExp != null) {
            	var oldCanvas = document.getElementById("expCanvas");
            	var emptyCanvas = getCanvasElement();
            	oldCanvas.parentNode.replaceChild(emptyCanvas, oldCanvas);
            	var newCanvas = document.getElementById("expCanvas");
...
//            	ctx.stroke();
            	...
            	ctx.textAlign = "left";      
            	ctx.fillText(_this.globalExp, 150, 60); 
            }
        ...
        MockJSTM.prototype.makeExpressionDisplay = function () {
            var expDisp = getCanvasElement();// makeDivElement();
