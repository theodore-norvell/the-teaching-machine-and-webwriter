...
import tm.cpp.datum.DoubleDatum;
import tm.interfaces.TypeInterface;
import tm.utilities.Assert;
import tm.virtualMachine.MemRegion;
import tm.virtualMachine.VMState;

public class TyDouble extends TypeNode implements TyFloating, TyCpp {

	private TyDouble() {
		super() ; }

	private static TyDouble [] qualified = new TyDouble [4];

	/**
	 * Returns a <code>TyDouble</code> instance with default (none/auto) 
	 * cv-qualification.
	 * @return a <code>TyDouble</code> instance
	...
	/**
	 * Returns a <code>TyDouble</code> instance with the indicated 
	 * cv-qualification.
