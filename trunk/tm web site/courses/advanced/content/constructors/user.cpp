// There's an error in this file. Can you use the TM to spot it
...
int main(){
/*#TC*/	User mpbl("Michael Bruce-Lockhart", "mpbl", "bftplx");
	User theo("Theo Norvell", "theo", "charl1eB");/*#/TC*/
/*#TD*/	User mpblClone(mpbl);/*#/TD*/
	mpbl.setAllocation(100);
/*#TE*/	//mpblClone.setPassword(MyString("unlucky"), MyString("unlucky"));
	MyString noLuck("unlucky");
	mpblClone.setPassword(noLuck, noLuck);/*#/TE*/
...
/*#TB*/ User::User(char* n, char* u, char* p) : mName(n),
