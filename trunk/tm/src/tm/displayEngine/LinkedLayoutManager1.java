...
import tm.portableDisplays.LinkedD3Iterator1 ;
  ...
  public class LinkedLayoutManager1 {
	     ...
	     private LinkedDisplay1 owner;
	     
	     public LinkedLayoutManager1(LinkedDisplay1 o){
	         owner = o;
	     }
	 ...
	 */
	     public void layoutDisplay(AbstractGenerator generator){
	         ...
	         tm.portableDisplays.LinkedDatumDisplay current = null;
	         LinkedD3Iterator1 myIterator = new LinkedD3Iterator1(generator, owner);//generator.getIterator(owner);
