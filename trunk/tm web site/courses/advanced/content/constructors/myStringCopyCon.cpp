...
/*#TG*/    MyString password("bfltpx");	// Hah! Get that one.
...
/*#TD*/bool MyString::compare(MyString& other){
...
/*#TE*/void MyString::changeTo(char* newString){
...
/*#TF*/ // Overloaded version of changeTo to allow the string to
