...
public class StatEndCatch extends StatementNode {

    StatementNodeLink nextLink = new StatementNodeLink() ;

    public StatEndCatch (SourceCoords coords, int varDepth) {
        super("end catch", coords, varDepth);
    }
    ...
    public String toString( Hashtable h ) {
        return "    (" + h.get( this ) + ") StatEndCatch line="+getCoords()+" depth="+getVarDepth()+"\n"
