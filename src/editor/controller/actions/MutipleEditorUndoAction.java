...
public class MutipleEditorUndoAction extends AbstractAction {
    private EditorViewBase view;

    public MutipleEditorUndoAction(EditorViewBase view) {
        this.view = view;
    }

    public void actionPerformed(ActionEvent e) {
        int currentIndex = view.getCurrentActiveEditorIndex();
        KeyStroke key=KeyStroke.getKeyStroke(KeyEvent.VK_Z, Event.CTRL_MASK);  //redo
        if (view.getTextPanel(currentIndex) != null) {
            ...
            view.setStatusString("UndoAction is null");
    }
}
