...
public class CGRLvalueTest extends CGRTest {
        ...
        public boolean applies (ExpressionPtr exp) {
            ...
            // [TSN, 2003 July 16] Why does this return true in the case of
            // an ExpFetch that is not a TyAbstractRef?
            if (e instanceof ExpFetch ||
                e.get_type () instanceof TyAbstractRef)
                testResult = true;
            return testResult;
        }
}