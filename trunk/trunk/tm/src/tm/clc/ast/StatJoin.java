...
public class StatJoin extends StatementNode {
    StatementNodeLink nextLink ;

    public StatJoin (SourceCoords coords, int varDepth) {
        super("join", coords, varDepth) ;
    ...
    public String toString( Hashtable h ) {
        return "    (" + h.get( this ) + ") StatJoin line="+getCoords()+" depth="+getVarDepth()+"\n"
