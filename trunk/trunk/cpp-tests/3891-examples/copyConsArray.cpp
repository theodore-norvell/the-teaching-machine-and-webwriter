...
/*#HB*/	for (int j = 0; j < smallArray.getSize(); j++)
...
// The destructor has already been defined implicitly.
// This is a second defnition and should result in an error
// report.
Array::~Array(){
...
/*#DC*/Array Array::add(Array other){
