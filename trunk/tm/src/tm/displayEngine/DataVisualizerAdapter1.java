...
//import tm.portableDisplays.LinkedDisplayer;
...
// * @author mpbl
// */
//public abstract class DataVisualizerAdapter1 extends SwingDisplay{
//	
...
//	public LinkedDisplayer linkDisplayer;
//	
//	
///**
// * 
...
// */
//	public DataVisualizerAdapter1(DisplayManager dm, String configId) {
//		super(dm, configId, new LinkedDisplayer(dm.getCommandProcessor(), dm.getPortableContext()));
//		if (this.displayer instanceof LinkedDisplayer) {
//			this.linkDisplayer = (LinkedDisplayer) this.displayer;
//		}
//		myGenerator = new SelectionGenerator(dm, this);		
////		setPreferredSize(this.getViewportSize());
//		generatorMode = SELECTION;
//		linkDisplayer.getDisplayInfo().setMyGenerator(myGenerator);
//	}
//
///**
...
////		Graphics offscreen = (Graphics)snap.getGraphics();
