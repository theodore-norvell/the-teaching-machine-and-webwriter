...
public abstract class AbstractTaggedSubgraph
    <   T extends Tag<T,NP>,
    ...
    >
extends AbstractSubgraph<NP,EP,HG,WG,SG,N,E>
implements TaggedSubgraph<T,NP,EP,HG,WG,SG,N,E>,
           AbstractTaggedHigraph<T,NP,EP,HG,WG,SG,N,E>
{

    protected AbstractTaggedSubgraph(WG wholeGraph) {
        super(wholeGraph);
    }
