...
/**
	 * 
	 */
	private static final long serialVersionUID = 1773344261339058465L;
	...
	private Dimension onlySize = new Dimension(WIDTH,HEIGHT);
         ...
         */        
	public SmallButton(int i, ImageSourceInterface is) {
		super();
         ...
         * @param is the image source
         */        
	public SmallButton(String s, ImageSourceInterface is) {
		super();
		myString = s;
		setIcon(new ImageIcon(
				is.fetchImage("subWindowPkg/" + myString + ".gif")));
