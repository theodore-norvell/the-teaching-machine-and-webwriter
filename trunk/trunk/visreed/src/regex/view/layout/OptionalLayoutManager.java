...
/**
 * KleeneStarLayoutManager handles children layout algorithms for {@link regex.view.KleeneStarNodeView}
 * @author Xiaoyu Guo
 */
public class OptionalLayoutManager extends RegexNodeLayoutManager {
    ...
    protected OptionalLayoutManager() {}
    ...
    private static OptionalLayoutManager instance = new OptionalLayoutManager();
