...
(function (jstm_1) {
    var concreteJSTM = (function () {
        ...
        concreteJSTM.prototype.setInputExpressionSpanElement = function () {
            ...
            this.inputExpressionSpanElement.innerHTML = 'expression: ';
        ...
        concreteJSTM.prototype.setoutputVarsSpanElement = function (inputVars) {
            var count = Object.keys(inputVars).length;
            for (var i = 0; i < count; i++) {
        ...
        concreteJSTM.prototype.setoutputVarsInputElement = function (inputVars) {
            var count = Object.keys(inputVars).length;
            for (var i = 0; i < count; i++) {
        ...
        concreteJSTM.prototype.setoutputVariableSpanElement = function (outPutVars) {
        ...
        concreteJSTM.prototype.setoutputVariableinputElement = function (outPutVars) {
        ...
        concreteJSTM.prototype.buildOutputElement = function () {
            ...
            this.setoutputVarsSpanElement(quizBuilder.Quiz.tempIndex.inputVars);
            this.setoutputVarsInputElement(quizBuilder.Quiz.tempIndex.inputVars);
            this.setoutputVariableSpanElement(quizBuilder.Quiz.tempIndex.outPutVars);
            this.setoutputVariableinputElement(quizBuilder.Quiz.tempIndex.outPutVars);
        };
        ...
        concreteJSTM.prototype.constructInsertArea2 = function () {
            $('#insert2').empty();
