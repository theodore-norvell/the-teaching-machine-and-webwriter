...
public class StatStartFinally  extends StatementNode {
    ...
    public String toString( Hashtable h ) {
        return "    (" + h.get( this ) + ") StatStartFinally line="+getCoords()+" depth="+getVarDepth()+"\n"
