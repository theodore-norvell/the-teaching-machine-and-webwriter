	...
	/**	$('#createRemoteTM').click(function() {
        ...
        $("#goForward1").click(function(){
            ...
            $.post('goForward.go', {
            	...
            	json.parameter[0].expression=parameterTemp.expression;
            	/**parse the characters of the expression**/
/*            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\uffff]/g,"RED");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\ufffe]/g,"STOPUNDER");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\ufffd]/g,"UNDER");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\ufffc]/g,"BLUE");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\ufffb]/g,"END");*/
            	
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\uffff]/g,"<span class='tm-red'>");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\ufffe]/g,"");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\ufffd]/g,"<span class='tm-underline'>");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\ufffc]/g,"<span class='tm-blue'>");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[\ufffb]/g,"</span>");
            	
            	/*json.parameter[0].expression=json.parameter[0].expression.replace(/[RED]/g,"<span class='tm-red'>");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[STOPUNDER]/g,"");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[UNDER]/g,"<span class='tm-underline'>");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[BLUE]/g,"<span class='tm-blue'>");
            	json.parameter[0].expression=json.parameter[0].expression.replace(/[END]/g,"</span>");*/
            	//alert(json.parameter[0].expression);
/*        		var s1="";
        		var s2= json.parameter[0].expression;
        		for(var i=0;i<s2.length;i++)
        			{
        		...
        		if(json.parameter[0].status!=6&&json.parameter[0].status!=7){
     		    $('#responseconsole').text("");
                $('#responseconsole').append("<p>"+json.parameter[0].expression+"</p>"+"<br>");
