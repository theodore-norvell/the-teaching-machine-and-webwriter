...
public class PLAYViewSelectionModel {
    ...
    private List<Object> selectedViewList;
	...
	this.selectedViewList = new ArrayList<Object>();
	this.anchor = 0;
	this.focus = 0;
    }
    ...
    public void addSelectedView(Object view) {
    ...
    public List<Object> getSelectedViewList() {
