...
(function (quizBuilder) {
    ...
    var Quiz = (function () {
        ...
        Quiz.prototype.setCodeFunction = function (codeFunction) {
            this.codeFunction = codeFunction;
        };
        Quiz.prototype.setCodeMain = function (codeMain) {
    ...
    var FITEQuizQuizBuilder = (function (_super) {
        ...
        FITEQuizQuizBuilder.prototype.buildCode = function () {
            this.quiz.setCodeFunction(Quiz.tempIndex.codeFunction);
            this.quiz.setCodeMain(Quiz.tempIndex.codeMain);
        };
        ;
