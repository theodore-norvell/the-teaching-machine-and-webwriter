...
/** The {@link ScopeHolder} for Java functions
 * @author mpbl
 */
public class SHFunction extends SHCommon {
    
    /** Creates a new instance of SHBlock
     * @param encl The enclosing ScopeHolder
     */
    public SHFunction(ScopeHolder encl) {
        super(encl);
    }
     ...
     */    
     public String toString(){
     	return (isStaticContext() ?	"static " : "" ) + 	
			"scope of function " + super.toString();
     }
